...
if(isset($_POST['page']))
{
	if($_POST['page'] == 'register')
	{
		...
		if($_POST['action'] == 'register')
		{
			...
			(user_email_address, user_password,  user_name, user_mobile_no, user_created_on)
			VALUES 
			(:user_email_address, :user_password, :user_name,:user_mobile_no, :user_created_on)";
	...
	if($_POST['page'] == "profile")
	{
		...
		// 	}
			...
			$exam->query = "
			UPDATE user_table 
			SET user_name = :user_name, user_address = :user_address, user_mobile_no = :user_mobile_no,
